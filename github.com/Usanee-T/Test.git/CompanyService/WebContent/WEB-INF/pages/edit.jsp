...
<body>
	<center>
		...
		<div style="color: teal; font-size: 30px">Update Employee Details</div>
		...
		<form:form id="registerForm" modelAttribute="employee" method="post" action="update">
			<table width="400px" height="150px">
				...
				<tr>
					...
					<td><form:input path="position" value="${employeeObject.position}"/></td>
				</tr>
				<tr>
					<td><form:label path="address">Address</form:label></td>
					<td><form:input path="address" value="${employeeObject.address}"/></td>
				</tr>
				<tr>
